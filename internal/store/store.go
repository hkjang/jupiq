...
func (s *Store) Seed(ctx context.Context, username, password string) error {
	...
	defaults := map[string]any{
		...
		"auth.oidc":     map[string]any{"enabled": false, "issuer_url": "", "client_id": "", "redirect_url": "", "scopes": []string{"openid", "profile", "email"}, "username_claim": "preferred_username", "auto_create_users": true, "verify_tls": true, "auto_login": false},
